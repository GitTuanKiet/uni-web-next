...
export const EmailVerificationTemplate = ({ code }: EmailVerificationTemplateProps) => {
  return (
    <Html>
      <Head />
      <Preview>Verify your email address to complete your {Info_App.title} registration</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section>
            ...
            <Text style={text}>
              Thank you for registering for an account on {Info_App.title}. To complete your
