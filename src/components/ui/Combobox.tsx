...
import { useCombobox, type OptionWithIcon } from '@/hooks';
        ...
        <RadixSelect.Portal>
          ...
          >
            <RadixSelect.Viewport className="mb-5 h-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)]">
              <div className="group sticky left-0 top-0 z-10 flex h-12 items-center gap-2 bg-white p-2 text-black duration-300 dark:bg-gray-700 dark:text-white">
